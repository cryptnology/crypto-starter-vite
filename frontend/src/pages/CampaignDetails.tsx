      ...
      <div className="mx-auto max-w-[900px]">
        <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
          <div className="flex-1 flex-col">
            ...
            />
            <div className="relative w-full h-[5px] bg-gray-300 dark:bg-secondaryDark mt-2 rounded-[10px]">
              <div
                className="absolute h-full bg-primary dark:bg-[#58E6D9] rounded-[10px]"
                style={{
